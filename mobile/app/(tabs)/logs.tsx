...
const styles = StyleSheet.create({
  ...
  detailButton: { borderRadius: 16, borderWidth: 1, paddingHorizontal: 14, paddingVertical: 10 },
  paginationRow: { gap: 12, marginTop: 18 },
  pageButtons: { flexDirection: 'row', gap: 10 },
  pageButton: { flex: 1, borderWidth: 1, borderRadius: 16, alignItems: 'center', justifyContent: 'center', minHeight: 46 },
